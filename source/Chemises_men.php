            ...
            <ul class="icons">
                ...
                <li class="profileicon"><a href=""><img src="./F.R.I.E.N.D.S_files/icons8-male-user-48.png" alt="" class="profileicon" id="profileicon">
                  ...
                  <div class="dropdown-content">
                    ...
                    <a href="./derdourmohamedphp/register.php">Register</a>                    <button id="dark" class="dark"><img src="./F.R.I.E.N.D.S_files/icons8-crescent-moon-50.png" alt="" class="darkbtn">
...
<?php
	...
	$sql="SELECT * FROM `articleshomme` WHERE sexe='m' ORDER BY $var ";
